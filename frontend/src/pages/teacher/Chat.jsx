    ...
    <div className="min-h-screen bg-[#f0f2f5] flex flex-col h-screen">
      ...
      <nav className="bg-white border-b px-6 py-3 flex items-center justify-between shadow-sm z-10">
        <div className="flex items-center gap-4">
          <Link to="/teacher/requests" className="p-2 hover:bg-gray-100 rounded-full transition-colors">
        ...
        <div className="flex items-center gap-2">
          <span className="hidden md:inline-block px-3 py-1 bg-green-50 text-green-700 text-xs font-semibold rounded-full">
            {appointment?.topic}
          </span>
        </div>
      </nav>
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-end gap-1 mt-1">
                ...
                {isMyMessage(msg) && (
                  <span className={`text-[10px] ${msg.seen ? 'text-green-500' : 'text-gray-400'}`}>
                    ✓✓
                  </span>
                )}
              </div>
